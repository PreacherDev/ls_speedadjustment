    ...
    while true do 
        ...
        if IsPedSittingInAnyVehicle(playerPed) then 
            ...
            if grounds[currentGround] and not ignored then 
                ...
                local groundMultiplier = Config.SpeedAdjustments[currentClass] and Config.SpeedAdjustments[currentClass][grounds[currentGround]]
                if groundMultiplier then 
                    local groundMaxSpeed   = (maxSpeed*groundMultiplier)
